...
interface GoalTreeProps {
  goals: (Goal & { category: GoalCategory })[]
  currentGoal: Goal & { category: GoalCategory; parentGoal: Goal; status: GoalStatus }
  patientId: number
                  ...
                  >
                    ...
                    <span
                      className={`${getBadgeColor(
                        categoryName
                      )} tag-lg ml-4 font-medium text-gray-800`}
                    >
                      {categoryName}
                    </span>
                  </Disclosure.Button>
                  <Disclosure.Panel as="li" static={currentGoal.category.name === categoryName}>
                    {parentGoals
                                ...
                                (childGoal) =>
                                  childGoal.parentGoalId === goal.id && (
                                    <Disclosure.Panel
                                      ...
                                      } block w-auto text-left py-2 px-3 ml-16  shadow overflow-hidden rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500`}
                                    >
                                      <span>
